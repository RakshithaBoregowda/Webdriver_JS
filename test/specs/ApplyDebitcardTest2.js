...
await browser.acceptAlert()
var logoutButton= await browser.$("//input[@name='logout_btn']")
logoutButton.click();
...
console.log(debitCardNum)
 ...
 it("staff login for validation",async()=>{
 ...
 ////th[.='#']/parent::tr/following::tr/td[11]
 ...
 {
  var iterator=await browser.$$("//th[.='#']/parent::tr/following::tr/td[11]")[index].getText()///debit
